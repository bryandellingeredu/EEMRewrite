        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeekdayOfMonth = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IntervalStart = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IntervalEnd = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IncludeWeekends = table.Column<bool>(type: "bit", nullable: false),
                    DaysRepeating = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WeeksRepeating = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MonthsRepeating = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WeekInterval = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WeekendsIncluded = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WeeklyRepeatType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MonthlyRepeatType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MonthlyDayType = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AppUserId = table.Column<string>(type: "nvarchar(225)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionOfficer = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ActionOfficerPhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    EventLookup = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrganizationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RecurrenceInd = table.Column<bool>(type: "bit", nullable: false),
