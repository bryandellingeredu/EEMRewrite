...
export default function NavbarCommunityCalendar(){
  const {
    navbarStore: {setPage },
  } = useStore();
...
useEffect(() => {
    ...
    return(
        ...
        <Menu.Item position="left">
          ...
          <Menu.Item header  >  
         { isMobile && <h3>USAWC <br /> Community Calendar </h3> }
         { !isMobile && <h3>United States Army War College Community Calendar</h3> }
