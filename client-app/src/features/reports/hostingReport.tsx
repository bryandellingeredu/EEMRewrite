...
import { HostingReportComponentToPrint } from "./hostingReportComponentToPrint";

export default observer(function HostingReport() {
      ...
      return (
        <>
          <Divider horizontal>
            <Header as="h2">
              <Icon name="file" />
              View and Print {activity.report}
            </Header>
          </Divider>
          {loadingInitial && <LoadingComponent content="Loading Report" />}
